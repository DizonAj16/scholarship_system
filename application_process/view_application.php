...
try {
    ...
    if (!$application) {
        header("Location: ../views/my_applications.php?error=Application not found");
        exit;
    }
...
<body>
    ...
    <div class="container">
        ...
        <h1>My Scholarship Application Details</h1>
        ...
        <div class="section">
            ...
            <div class="details">
                ...
                <p><i class="fas fa-book"></i><strong>Course:</strong> <?= htmlspecialchars($application['course']) ?>
                </p>
        ...
        <a href="../views/my_applications.php" class="btn-back">
            <i class="fas fa-chevron-left"></i> Back to My Applications
        </a>
    </div>
