...
// Note: There's a typo in your original query - 'not qualiied' should be 'not qualified'
// I'm using 'not qualified' assuming that's the correct status
try {
    // Fetch total records count
    $countStmt = $pdo->prepare("SELECT COUNT(*) FROM scholarship_applications WHERE status = 'not qualified'");
    $countStmt->execute();
...
<body>
    ...
    <div class="print-header">
        <h1>NOT QUALIFIED SCHOLARSHIP APPLICATIONS</h1>
    ...
    <main>
        <h2 class="no-print">List of Not Qualified Applications</h2>
        ...
        <div class="print-summary">
            ...
            Total Not Qualified Applications: <?php echo $totalRecords; ?><br>
            <?php if ($limit === 'all'): ?>
                Displaying: All <?php echo $totalRecords; ?> records
            <?php else: ?>
                Displaying: <?php echo count($rejectedApplications); ?> records (Page <?php echo $page; ?> of <?php echo $totalPages; ?>)
            <?php endif; ?>
        </div>
